       ...
       <div id="kc-form" class="kc-form">
            <div id="kc-form-wrapper">
                ...
                <form id="kc-reset-password-form" class="${properties.kcFormClass!}" action="${url.loginAction}" method="post">
                    ...
                    <div class="${properties.kcFormGroupClass!} ${properties.kcFormSettingClass!} username_wapper">
                        ...
                        <div id="kc-form-buttons" class="${properties.kcFormButtonsClass!}">
                            <input class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!} submit_btn" type="submit" value="${msg("doSubmit")}"/>
                        </div>
                    </div>
                </form>
            </div>
