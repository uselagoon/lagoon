...
import (
	...
	mockapi "github.com/uselagoon/lagoon/services/webhooks/internal/lagoon/fakeapi"
...
func TestEvents_HandlePull(t *testing.T) {
	...
	oBuildNameSeed := buildNameSeed
	buildNameSeed = mockBuildSeed()
	defer func() { buildNameSeed = oBuildNameSeed }()
