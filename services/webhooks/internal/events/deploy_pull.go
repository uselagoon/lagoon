...
func (e *Events) deployPull(project schema.Project, environmentName, buildName, sourceUser, bulkID, bulkName string) ([]byte, error) {
	...
	for _, env := range project.Environments {
		...
		if project.StandbyProductionEnvironment == environmentName || project.ProductionEnvironment == environmentName {
