...
func (e *Events) deployPush(project schema.Project, branchName, buildName, sourceUser, bulkID, bulkName string) ([]byte, error) {
	...
	for _, env := range project.Environments {
		if env.Name == branchName {
			deployTarget = &env.DeployTarget
		}
		if project.StandbyProductionEnvironment == branchName || project.ProductionEnvironment == branchName {
