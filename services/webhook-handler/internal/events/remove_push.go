...
func (e *Events) removePush(project schema.Project, environment schema.Environment, sourceUser string) ([]byte, error) {
	...
	log.Println("remove environment from project", environment.Name, project.Name, environment.DeployTarget.Name)
