...
async function resticbackupSnapshotPruned(webhook: WebhookRequestData) {
  // Disable resticbackupSnapshotPruned for now, until https://github.com/amazeeio/lagoon/issues/919 is fixed
  return;
...
module.exports = resticbackupSnapshotPruned;
