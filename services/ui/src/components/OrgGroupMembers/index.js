  ...
  return (
    ...
    <div className="deployments">
      ...
      <div key={member.user.email} className="data-row" deployment={member.user.email}>
        <div className="name">{member.user.email} {(member.user.comment.includes("autogenerated user for project") ) && (<label className="system-user-label">system account</label>)}</div>
