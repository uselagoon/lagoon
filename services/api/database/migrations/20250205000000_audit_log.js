...
exports.up = async function(knex) {
    ...
    if (!organizations) {
        ...
        .createTable('audit_log', function (table) {
            ...
            table.enu('resource_type', ['backup', 'bulkdeployment', 'deployment', 'deploytarget', 'deploytargetconfig', 'environment', 'group', 'notification', 'organization', 'project', 'task', 'user', 'variable','workflow']);
            ...
            table.enu('linked_resource_type', ['backup', 'bulkdeployment', 'deployment', 'deploytarget', 'deploytargetconfig', 'environment', 'group', 'notification', 'organization', 'project', 'task', 'user', 'variable','workflow']);
