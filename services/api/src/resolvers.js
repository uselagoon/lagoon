...
const {
  ...
  cloneProject,
  updateProjectClone,
  executeCloneRestoreTask,
  executeCloneDeployment,
  copyProjectGroups,
  copyProjectNotifications,
  copyProjectMetadata,
  copyProjectVariables,
  copyEnvironmentVariables,
  getProjectCloneByProject,
  getDeploymentsByProjectForCloneProjectId,
  getSourceProjectForCloneProject,
  getDestinationProjectForCloneProject,
  getDeploymentsByDestinationProjectForCloneProjectId,
...
async function getResolvers() {
  ...
  const resolvers = {
    ...
    Restriction: {
      NO_PROJECT_VARIABLES: 'no_project_variables',
      NO_ENVIRONMENT_VARIABLES: 'no_environment_variables',
      NO_TASKS: 'no_tasks',
      NO_DEPLOYMENTS: 'no_deployments',
      NO_WEBHOOK_DEPLOYMENTS: 'no_webhook_deployments',
    },
    Openshift: {
    ...
    ProjectCloneDestination: {
      deployments: getDeploymentsByDestinationProjectForCloneProjectId,
      tasks: getTasksByDestinationProjectForCloneProjectId,
    },
  ...
  Query: {
    ...
    allProjectsPaginated: getAllProjectsPaginated,
    allOpenshifts: getAllOpenshifts,
    allKubernetes: getAllOpenshifts,
    allEnvironments: getAllEnvironments,
    allEnvironmentsPaginated: getAllEnvironmentsPaginated,
