...
async function getResolvers() {
  ...
  try {
    ...
    graphqlUpload = {
      ...GraphQLUpload,
      parseLiteral: (_ast) => null, // Allow literals but treats them as null - issue with graphql-upload & apollo-server3
