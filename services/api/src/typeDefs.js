...
const typeDefs = gql`
  ...
  type Environment {
    ...
    apiRoutes(domain: String, source: RouteSource): [Route]
    autogeneratedRouteConfig: AutogeneratedRouteConfig
  ...
  type Route {
    ...
    tlsAcme: Boolean
    """
    Will handle automatic redirect from http to https on this route.
    """
    insecure: RouteInsecure
    annotations: [RouteAnnotation]
    pathRoutes: [PathRoute]
    """
    Is used to indicate if this route is the primary route when attached to an environment.
    """
    primary: Boolean
    """
    Alternate domains are typically subdomains of the main domain.
    """
    alternativeNames: [AlternativeName]
    """
    Whether the route is defined in the API or the Lagoon YAML file.
    """
    source: RouteSource
    """
    Route type determines if this is a standard route, or should be considered as an active or standby route.
    Active or Standby routes will transfer between environments that are listed under the projects productionEnvironment and standbyProductionEnvironment.
    """
    type: RouteType
    """
    If this route is on an environment that idles, request validation could prevent the environment from unidling when not accessed via a browser.
    Disabling request verification will allow the environment to unidle from any non-browser requests.
    """
    disableRequestVerification: Boolean
    hstsEnabled: Boolean
    hstsPreload: Boolean
  ...
  input UpdateProjectAutogeneratedRouteConfigInput {
    project: String!
    patch: AutogeneratedRouteConfigPatchInput!
  }

  input UpdateEnvironmentAutogeneratedRouteConfigInput {
    project: String!
    environment: String!
    patch: AutogeneratedRouteConfigPatchInput!
  }

  input AutogeneratedRouteConfigPatchInput {
    enabled: Boolean
    allowPullRequests: Boolean
    prefixes: [String]
  ...
  input AutogeneratedPathRouteInput {
    fromService: String
    toService: String
    path: String
  }
  ...
  input AddRouteToProjectInput {
    ...
    annotations: [AddRouteAnnotationInput]
    pathRoutes: [PathRouteInput]
    source: RouteSource
    tlsAcme: Boolean
    insecure: RouteInsecure
    hstsEnabled: Boolean
  ...
  input UpdateRouteInput {
    domain: String!
    project: String!
    patch: UpdateRoutePatchInput!
  }

  input UpdateRoutePatchInput {
    tlsAcme: Boolean
    insecure: RouteInsecure
    hstsEnabled: Boolean
    hstsPreload: Boolean
  ...
  input AddOrUpdateEnvironmentRouteInput {
    domain: String!
    project: String!
    environment: String!
    service: String!
  ...
  input ActiveStandbyRouteMoveInput {
    domain: String!
    project: String!
    environment: String!
  }

  input RemoveRouteFromEnvironmentInput {
    domain: String!
    project: String!
    environment: String!
  }

  input AddRouteAlternativeDomainInput {
    id: Int!
    alternativeNames: [String]!
  }

  input RemoveRouteAlternativeDomainInput {
    id: Int!
    domain: String!
  }

  input AddRouteAnnotationInput {
    key: String!
    value: String!
  }

  input AddRouteAnnotationsInput {
    id: Int!
    annotations: [AddRouteAnnotationInput]!
  }

  input RemoveRouteAnnotationInput {
    id: Int!
    key: String!
  }

  input AddPathRoutesInput {
    id: Int!
    pathRoutes: [PathRouteInput]!
  }

  input RemovePathRoutesInput {
    id: Int!
    toService: String!
    path: String!
  }

  input PathRouteInput {
    toService: String!
    path: String!
  }
  ...
  input IdleEnvironmentInput {
    project: String!
    environment: String!
    idle: Boolean!
    disableAutomaticUnidling: Boolean
  }

  input EnvironmentServiceActionInput {
    project: String!
    environment: String!
    serviceName: String!
    state: EnvironmentServiceAction!
  }
  ...
  input GetProjectCloneFileUploadFormInput {
    cloneId: Int!
    filename: String!
  }
  ...
  type Mutation {
    ...
    # ROUTES
    addRouteToProject(input: AddRouteToProjectInput!): Route
    updateRouteOnProject(input: UpdateRouteInput!): Route
    addRouteAlternativeDomains(input: AddRouteAlternativeDomainInput!): Route
    removeRouteAlternativeDomain(input: RemoveRouteAlternativeDomainInput!): Route
    addRouteAnnotation(input: AddRouteAnnotationsInput!): Route
    removeRouteAnnotation(input: RemoveRouteAnnotationInput!): Route
    addPathRoutesToRoute(input: AddPathRoutesInput!): Route
    removePathRouteFromRoute(input: RemovePathRoutesInput!): Route
    addOrUpdateRouteOnEnvironment(input: AddOrUpdateEnvironmentRouteInput!): Route
    activeStandbyRouteMove(input: ActiveStandbyRouteMoveInput): Route
    removeRouteFromEnvironment(input: RemoveRouteFromEnvironmentInput!): Route
    deleteRoute(input: DeleteRouteInput!): String
    updateAutogeneratedRouteConfigOnProject(input: UpdateProjectAutogeneratedRouteConfigInput!): AutogeneratedRouteConfig
    updateAutogeneratedRouteConfigOnEnvironment(input: UpdateEnvironmentAutogeneratedRouteConfigInput!): AutogeneratedRouteConfig
    removeAutogeneratedRouteConfigFromProject(project: String!): String
    removeAutogeneratedRouteConfigFromEnvironment(project: String!, environment: String!): String
    idleOrUnidleEnvironment(input: IdleEnvironmentInput!): String
    ...
    copyProjectGroups(sourceProject: String!, destinationProject: String!)
    copyProjectNotifications(sourceProject: String!, destinationProject: String!)
    copyProjectMetadata(sourceProject: String!, destinationProject: String!)
    copyProjectVariables(sourceProject: String!, destinationProject: String!)
    copyEnvironmentVariables(sourceProject: String!, sourceEnvironment: String!, destinationProject: String!, destinationEnvironment: String!)
  }
