...
const typeDefs = gql`
  ...
  type Query {
    ...
    """
    allDeploymentTargets: [DeploymentTarget]
    """
  ...
  type Mutation {
    ...
    addProjectDeploymentTargetRule(input: AddProjectDeploymentTargetRuleInput): Project
    updateProjectDeploymentTargetRule(input: UpdateProjectDeploymentTargetRuleInput): Project
    deleteProjectDeploymentTargetRule(input: DeleteProjectDeploymentTargetRuleInput): Project
  }
