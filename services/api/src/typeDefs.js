...
const typeDefs = gql`
  ...
  type ProjectClone {
    id: Int
    sourceProject: ProjectCloneSource
    destinationProject: ProjectCloneDestination
    status: CloneStatus
    created: String
    updated: String
    files: [File]
  ...
  type Project {
    ...
    *Important:* This is mainly used for drupal, but could be used for other services potentially
    ...
    """
    deploymentsDisabled: Int @deprecated(reason: "Use restrictions instead")
    """
  ...
  input CloneProjectInput {
    projectName: String!
    sourceProject: CloneProjectSourceInput
    sourceEnvironment: CloneProjectSourceEnvironmentInput
  }
  ...
  input CloneProjectSourceEnvironmentInput {
    name: String
  ...
  input ExecuteCloneDeploymentInput {
    cloneId: Int!
  }
  ...
  type Mutation {
    ...
    generateOrganizationKey(input: AddOrganizationKeyInput!): OrganizationKey
