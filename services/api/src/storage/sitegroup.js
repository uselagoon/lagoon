...
export const siteGroupToYaml = (siteGroup: SiteGroup): string => // TODO: Eventually use a schema?
Yaml.safeDump(siteGroup);

export const writeSiteGroupsFile = (repoPath: string, yamlContent: string): Promise<*> =>
...
export const parseSiteGroupFile = (yamlContent: string): SiteGroupFile => R.compose(
