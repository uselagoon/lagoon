...
export const Sql = {
  ...
  removeAllRoutesFromEnvironment: (environmentId: number) =>
    knex('routes')
      ...
      .where('environment', environmentId)
      .toString(),
  deleteAutogeneratedRoutesForEnvironment: (environmentId: number) =>
    knex('routes')
      .where('environment', environmentId)
      .andWhere('type', 'autogenerated')
      .del()
      .toString(),
  deleteLagoonYAMLRoutesForEnvironment: (environmentId: number) =>
    knex('routes')
      .where('environment', environmentId)
      .andWhere('type', 'yaml')
      .del()
      .toString(),
  selectAutogeneratedRouteConfigByEnvironmentID: (environmentId: number) =>
    knex('routes_autogenerated_configuration')
      .where('type', 'environment')
      .andWhere('type_id', environmentId)
      .toString(),
  deleteAutogeneratedRouteConfigForEnvironment: (environmentId: number) =>
    knex('routes_autogenerated_configuration')
      .where('type', 'environment')
      .andWhere('type_id', environmentId)
      .del()
      .toString(),
  selectAutogeneratedRouteConfigByProjectID: (projectId: number) =>
    knex('routes_autogenerated_configuration')
      .where('type', 'project')
      .andWhere('type_id', projectId)
      .toString(),
  deleteAutogeneratedRouteConfigForProject: (projectId: number) =>
    knex('routes_autogenerated_configuration')
      .where('type', 'project')
      .andWhere('type_id', projectId)
      .del()
