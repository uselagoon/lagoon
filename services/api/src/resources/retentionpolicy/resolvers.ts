...
) => await createRetentionPolicy(sqlClientPool, hasPermission, userActivityLogger, input, 'harbor');

export const createHistoryRetentionPolicy: ResolverFn = async (
  _root,
  { input },
  { sqlClientPool, hasPermission, userActivityLogger },
) => await createRetentionPolicy(sqlClientPool, hasPermission, userActivityLogger, input, 'history');
...
export const updateHarborRetentionPolicy: ResolverFn = async (
  ...
  { input },
  { sqlClientPool, hasPermission, userActivityLogger },
) => await updateRetentionPolicy(sqlClientPool, hasPermission, userActivityLogger, input, 'harbor');

export const updateHistoryRetentionPolicy: ResolverFn = async (
  root,
  { input },
  { sqlClientPool, hasPermission, userActivityLogger },
) => await updateRetentionPolicy(sqlClientPool, hasPermission, userActivityLogger, input, 'history');
...
export const deleteHarborRetentionPolicy: ResolverFn = async (
  ...
  { name },
  { sqlClientPool, hasPermission, userActivityLogger },
) => await deleteRetentionPolicy(sqlClientPool, hasPermission, userActivityLogger, name, 'harbor');

export const deleteHistoryRetentionPolicy: ResolverFn = async (
  _root,
  { name },
  { sqlClientPool, hasPermission, userActivityLogger },
) => await deleteRetentionPolicy(sqlClientPool, hasPermission, userActivityLogger, name, 'history');
...
export const addHarborRetentionPolicyLink: ResolverFn = async (
  ...
  { input },
  { sqlClientPool, hasPermission, userActivityLogger },
) => await addRetentionPolicyLink(sqlClientPool, hasPermission, userActivityLogger, input, 'harbor');

export const addHistoryRetentionPolicyLink: ResolverFn = async (
  _root,
  { input },
  { sqlClientPool, hasPermission, userActivityLogger },
) => await addRetentionPolicyLink(sqlClientPool, hasPermission, userActivityLogger, input, 'history');
...
export const removeHarborRetentionPolicyLink: ResolverFn = async (
  ...
  { input },
  { sqlClientPool, hasPermission, userActivityLogger },
) => await removeRetentionPolicyLink(sqlClientPool, hasPermission, userActivityLogger, input, 'harbor');

export const removeHistoryRetentionPolicyLink: ResolverFn = async (
  _root,
  { input },
  { sqlClientPool, hasPermission, userActivityLogger },
) => await removeRetentionPolicyLink(sqlClientPool, hasPermission, userActivityLogger, input, 'history');
