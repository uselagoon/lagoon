...
export const advancedTaskFunctionFactory = (queryRunner, hasPermission = null, models, Sql, environmentHelpers, projectHelpers) => {
  ...
  return {
    ...
    advancedTaskDefinitionArguments: async function (taskDefinitionId) {
      return await getAdvancedTaskDefinitionArguments(queryRunner, taskDefinitionId);
    },
    permissions: {
...
export const getAdvancedTaskDefinitionArguments = async function (queryRunner, task_definition_id) {
