...
*/}}
{{- define "dbaas-shared.autogeneratedHost" -}}
...
Common labels
*/}}
{{- define "dbaas-shared.labels" -}}
helm.sh/chart: {{ include "dbaas-shared.chart" . }}
{{ include "dbaas-shared.selectorLabels" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{ include "dbaas-shared.lagoonLabels" . }}
...
Selector labels
*/}}
{{- define "dbaas-shared.selectorLabels" -}}
app.kubernetes.io/name: {{ include "dbaas-shared.name" . }}
...
Lagoon Labels
*/}}
{{- define "dbaas-shared.lagoonLabels" -}}
...
Annotations
*/}}
{{- define "dbaas-shared.annotations" -}}
