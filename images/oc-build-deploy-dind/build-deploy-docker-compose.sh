...
if oc auth --insecure-skip-tls-verify auth can-i create schedules.backup.appuio.ch -q > /dev/null; then
...
do
  ...
  if oc auth --insecure-skip-tls-verify auth can-i create prebackuppod.backup.appuio.ch -q > /dev/null; then
