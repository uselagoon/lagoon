...
TESTS = [api,features-kubernetes,features-kubernetes-2,features-kubernetes-3,features-api-variables,active-standby-kubernetes,nginx,drupal-php73,drupal-php74,drupal-postgres,python,gitlab,github,bitbucket,node-mongodb,elasticsearch]
CHARTS_TREEISH = main
