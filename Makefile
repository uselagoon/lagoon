...
deployment-test-services-main = broker openshiftremove openshiftbuilddeploy openshiftbuilddeploymonitor logs2slack logs2rocketchat logs2microsoftteams api ssh auth-server local-git local-api-data-watcher-pusher tests
