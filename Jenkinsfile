            ...
            '1 tests': {
              ...
              stage ('minishift tests') {
                try {
                  ...
                  sh "make minishift MINISHIFT_CPUS=\$(nproc --ignore 2) MINISHIFT_MEMORY=32GB MINISHIFT_DISK_SIZE=50GB MINISHIFT_VERSION=${minishift_version} OPENSHIFT_VERSION=${openshift_version}"
                  sh "make -O${SYNC_MAKE_OUTPUT} push-minishift -j4"
