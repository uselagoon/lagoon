            ...
            '1 tests': {
              ...
              stage ('minishift tests') {
                try {
                  ...
                  sh "make minishift MINISHIFT_CPUS=14 MINISHIFT_MEMORY=32GB MINISHIFT_DISK_SIZE=50GB MINISHIFT_VERSION=${minishift_version} OPENSHIFT_VERSION=${openshift_version}"
