            ...
            parallel (
              ...
              'start minishift': {
                stage ('start minishift') {
                  ...
                  sh "make minishift MINISHIFT_CPUS=12 MINISHIFT_MEMORY=50GB MINISHIFT_DISK_SIZE=50GB MINISHIFT_VERSION=${minishift_version} OPENSHIFT_VERSION=${openshift_version}"
                }
              },
