...
This document describes what actually happens during a Lagoon build and deployment. It is heavy simplified from what actually happens, but it will help you to understand what is happening under the hood every time that Lagoon deploys new code for you.
