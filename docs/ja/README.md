...
バグやサポートに関する質問は、該当する[uselagoonリポジトリ](https://github.com/orgs/uselagoon/repositories)にIssueを作成してください。

サポート以外の質問やアイデア共有は、[GitHub Discussion](https://github.com/uselagoon/lagoon/discussions)をご利用ください。
