...
| `PHP_ERROR_REPORTING`             | `E_ALL & ~E_DEPRECATED & ~E_STRICT` | The desired logging level you'd like PHP to use. [see php.net](https://www.php.net/manual/en/function.error-reporting.php)                                                                                                |
