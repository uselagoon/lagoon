...
| :--- | :--- | :--- | :--- | ---: | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Name** | **Resource** | **Scope** | **Attributes** | **Platform-Wide Admin** | **Platform-Wide Owner** | **Platform-wide Viewer** | **Owner** | **Maintainer** | **Developer** | **Reporter** | **Guest** | **Self** |
| addBackup | backup | add | projectID | Yes | Yes | No | Yes | Yes | Yes | No | No |  |
| deleteBackup | backup | delete | projectID | Yes | Yes | No | Yes | Yes | No | No | No |  |
| deleteAllBackups | backup | deleteAll |  | Yes |  |  |  |  |  | No | No |  |
| getBackupsByEnvironmentId | backup | view | projectID | Yes | Yes | Yes | Yes | Yes | Yes | No | No |  |
|  | deployment | view | projectID | Yes | Yes | Yes | Yes | Yes | Yes | Yes | Yes |  |
| addEnvVariable \(to Project\) | env\_var | project:add | projectID | Yes | Yes | No | Yes | No | No | No | No |  |
| addEnvVariable \(to Environment\) | env\_var | environment:add:development | projectID | Yes | Yes | No | Yes | Yes | Yes | No | No |  |
| addEnvVariable \(to Environment\) | env\_var | environment:add:production | projectID | Yes | Yes | No | Yes | Yes | No | No | No |  |
| deleteEnvVariable | env\_var | delete | projectID | Yes | Yes | No | Yes | Yes | No | No | No |  |
| getEnvVarsByProjectId | env\_var | project:view | projectID | Yes | Yes | No | Yes | Yes | No | No | No |  |
| getEnvVarsByEnvironmentId | env\_var | environment:view:development | projectID | Yes | Yes | No | Yes | Yes | Yes | No | No |  |
| getEnvVarsByEnvironmentId | env\_var | environment:view:production | projectID | Yes | Yes | No | Yes | Yes | No | No | No |  |
| addOrUpdateEnvironment | environment | addOrUpdate:development | projectID | Yes | Yes | No | Yes | Yes | Yes | No | No |  |
| addOrUpdateEnvironment | environment | addOrUpdate:production | projectID | Yes | Yes | No | Yes | Yes | No | No | No |  |
| updateEnvironment | environment | update:development | projectID | Yes | Yes | No | Yes | Yes | Yes |  |  |  |
| updateEnvironment | environment | update:production | projectID | Yes | Yes | No | Yes | Yes | No | No | No |  |
| deleteEnvironment | environment | delete:development | projectID | Yes | Yes | No | Yes | Yes | Yes | No | No |  |
| deleteEnvironment | environment | delete:production | projectID | Yes | Yes | No | Yes | No | No | No | No |  |
| deleteAllEnvironments | environment | deleteAll |  | Yes |  |  |  |  |  |  |  |  |
| addOrUpdateEnvironmentStorage | environment | storage |  | Yes | Yes |  |  |  |  |  |  |  |
| addDeployment | environment | deploy:development | projectID | Yes | Yes | No | Yes | Yes | Yes | No | No |  |
| addDeployment | environment | deploy:production | projectID | Yes | Yes | No | Yes | Yes | No | No | No |  |
| deleteDeployment | deployment | delete | projectID | Yes | Yes | No | Yes | Yes | No | No | No |  |
| updateDeployment | deployment | update | projectID | Yes | Yes | No | Yes | Yes | No | No | No |  |
| setEnvironmentServices | environment | update:development | projectID | Yes | Yes | No | Yes | Yes | Yes | No | No |  |
| setEnvironmentServices | environment | update:production | projectID | Yes | Yes | No | Yes | Yes | No | No | No |  |
| deployEnvironmentLatest | environment | deploy:development | projectID | Yes | Yes | No | Yes | Yes | Yes | No | No |  |
...
| addProject | project | add |  | Yes | Yes | No | Yes | Yes | Yes | Yes | Yes |  |
...
| taskDrushRsyncFiles | task | drushRsync:destination:development | ProjectID | Yes | Yes | No | Yes | Yes | Yes | No | No |  |
