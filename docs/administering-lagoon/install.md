...
Check the [Requirements for OpenShift by Lagoon](https://github.com/AlannaBurke/lagoon/tree/b9add2d0bfd8db43295d7ccdab7729436674f764/administering_lagoon/openshift_requirements.md) before continuing.
...
We have now a fully running Lagoon. Now it's time to configure the first project inside of it. Follow the examples in [GraphQL API](https://github.com/AlannaBurke/lagoon/tree/b9add2d0bfd8db43295d7ccdab7729436674f764/administering_lagoon/graphql_api.md)
